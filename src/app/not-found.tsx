  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background px-6 text-center">
      ...
      <h1 className="text-3xl font-bold text-text-primary font-heading">
        {isEn ? 'Page not found' : 'Pagina nao encontrada'}
      </h1>
      ...
      <a
        href={isEn ? '/en/' : '/pt/'}
        className="mt-8 inline-block rounded-lg bg-accent-dark px-6 py-3 text-text-on-accent font-semibold hover:opacity-90 transition-opacity"
      >
        {isEn ? 'Back to home' : 'Voltar para o inicio'}
      </a>
    </div>
  );
}
